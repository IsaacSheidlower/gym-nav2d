...
register(
    id='nav2dMediumNoDistXPenalty-v0',
    entry_point='gym_nav2d.envs:Nav2dMediumNoDistXPenaltyEnv',
)

register(
    id='nav2dMediumNoDistXandYPenalty-v0',
    entry_point='gym_nav2d.envs:Nav2dMediumNoDistXandYPenaltyEnv',
)